...
function Dta.ui.moreBtnClicked()
	...
	if not mainWindow.Alphabet then
		...
		mainWindow.ConnectorBtn = Dta.ui.createButton("itemDetailConnectorBtn", mainWindow, 8, 268, 160, nil, "<Connector>", nil, Dta.Tools.Connector.Toggle)
		mainWindow.LessBtn = Dta.ui.createButton("itemDetailLessBtn", mainWindow, 157, 268, 160, nil, Dta.Locale.Buttons.Less, nil, Dta.ui.lessBtnClicked)
	else
		mainWindow.Alphabet:SetVisible(true)
		mainWindow.ReskinBtn:SetVisible(true)
		mainWindow.SelectionsBtn:SetVisible(true)
		mainWindow.ConnectorBtn:SetVisible(true)
...
function Dta.ui.lessBtnClicked()
	...
	mainWindow.ConnectorBtn:SetVisible(false)
