...
function Dta.expimp_ui.createWindowExpImp(name, parent, title, width, height, x, y, closable, movable, closeCallback, moveCallback)
  ...
  windowExpImp.background2:SetPoint("CENTERY", windowExpImp, "CENTERY", nil, 40)
...
function Dta.expimp_ui.buildExpImpWindow()
  ...
  ExpImpwindow = Dta.expimp_ui.createWindowExpImp("ExpImpWindow",
                               ...
                               Dta.expimp_ui.ExpImpWindowMoved
                                ...
                                ExpImpwindow.ImportExport.ExportLabel = Dta.ui.createText("ImportExportExportLabel", ExpImpwindow.ImportExport, 0, 0, "Name:", 14)
                                ExpImpwindow.ImportExport.ExportLoad = UI.CreateFrame("SimpleSelect", "ExportNameSelect", ExpImpwindow.ImportExport)
                                ExpImpwindow.ImportExport.ExportLoad:SetPoint("TOPLEFT", ExpImpwindow.ImportExport, "TOPLEFT", 55, 0)
                                ...
                                ExpImpwindow.ImportExport.Export = Dta.ui.createButton("ImportExport_Export", ExpImpwindow.ImportExport, 0, 25, nil, nil, "Export", nil, Dta.expimp.ImportExport_ExportClicked)

                                ExpImpwindow.divider5 = Dta.ui.createTexture("divider5", ExpImpwindow, "Dimtools", "textures/divider.png", 10, 70, ExpImpwindow:GetWidth()-10)
                                ExpImpwindow.divider5:SetLayer(29)

                                ExpImpwindow.ImportExport.ImportLabel = Dta.ui.createText("ImportExportImportLabel", ExpImpwindow.ImportExport, 0, 85, "Name:", 14)
                                ExpImpwindow.ImportExport.ImportLoad = UI.CreateFrame("SimpleSelect", "ImportNameSelect", ExpImpwindow.ImportExport)
                                ExpImpwindow.ImportExport.ImportLoad:SetPoint("TOPLEFT", ExpImpwindow.ImportExport, "TOPLEFT", 55, 85)
                                ...
                                ExpImpwindow.ImportExport.Import = Dta.ui.createButton("ImportExport_Import", ExpImpwindow.ImportExport, 0, 110, nil, nil, "Import", nil, Dta.expimp.ImportExport_ImportClicked)
