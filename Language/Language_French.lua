...
---Intro------------------------------------------------------------------
Lang["French"].Intro = {}
Lang["French"].Intro.Label = "Introduction"
...
Lang["French"].Intro.Text2 = ""
Lang["French"].Intro.Text3 = ""

---Main-------------------------------------------------------------------
Lang["French"].Main = {}
Lang["French"].Main.Label = "Fenêtre principale"
Lang["French"].Main.Text1 = "\
...
Lang["French"].Main.Text3 = ""

---Move-------------------------------------------------------------------
Lang["French"].Move = {}
Lang["French"].Move.Label = "Translation"
Lang["French"].Move.Text1 = "\
Le module Translation est celui qui permet de régler la position des\
objets sélectionnés."

Lang["French"].Move.Text2 = "\
<u>Descriptions:</u>\
...
Lang["French"].Move.Text3 = ""

---Rotate------------------------------------------------------------*2/41_è-----
Lang["French"].Rotate = {}
Lang["French"].Rotate.Label = "Rotation"
Lang["French"].Rotate.Text1 = "\
...
Lang["French"].Rotate.Text3 = ""

---Scale------------------------------------------------------------------
Lang["French"].Scale = {}
Lang["French"].Scale.Label = "Taille"
Lang["French"].Scale.Text1 = "\
Le module Taille vous permet de régler la taille de vos objets (aggrandissement\
et réduction)."

Lang["French"].Scale.Text2 = "\
<u>Description:</u>\
...
Lang["French"].Scale.Text3 = ""

---Copy and Paste---------------------------------------------------------
Lang["French"].CopyandPaste = {}
Lang["French"].CopyandPaste.Label = "Copier et coller"
Lang["French"].CopyandPaste.Text1 = "\
...
Lang["French"].CopyandPaste.Text2 = "\
...
---Load and Save----------------------------------------------------------
Lang["French"].LoadandSave = {}
Lang["French"].LoadandSave.Label = "Charger et Sauvegarder"
Lang["French"].LoadandSave.Text1 = "\
...
---Import and Export------------------------------------------------------
Lang["French"].ImportandExport = {}
Lang["French"].ImportandExport.Label = "Importer et Exporter"
Lang["French"].ImportandExport.Text1 = "\
...
Lang["French"].ImportandExport.Text2 = "\
<u>Description:</u>\
...
Lang["French"].ImportandExport.Text3 = ""

---Tribal Magic-----------------------------------------------------------
Lang["French"].TribalMagic = {}
Lang["French"].TribalMagic.Label = "Tribal Magic"
Lang["French"].TribalMagic.Text1 = "\
...
Lang["French"].Afterword.Text2 = ""
Lang["French"].Afterword.Text3 = ""

---Offset Calc.-----------------------------------------------------------
Lang["French"].OffsetCalc = {}
Lang["French"].OffsetCalc.Label = "Calc. Align."
Lang["French"].OffsetCalc.Text1 = "\
...
Lang["French"].OffsetCalc.Text3 = ""

---Alfiebet-----------------------------------------------------------
Lang["French"].Alfiebet = {}
Lang["French"].Alfiebet.Label = "Alfiebet"
Lang["French"].Alfiebet.Text1 = "\
...
Lang["French"].Alfiebet.Text3 = ""

----------------------------------------
--Buttons
----------------------------------------
Lang["French"].Buttons = {}
Lang["French"].Buttons.MoveWindow = "Translation"
Lang["French"].Buttons.RotateWindow = "Rotation"
Lang["French"].Buttons.ScaleWindow = "Taille"
Lang["French"].Buttons.CopyPaste = "Copier / Coller"
Lang["French"].Buttons.LoadSave = "Charger / Sauv."
...
Lang["French"].Buttons.ImportText = "Importer Texte"
Lang["French"].Buttons.Export = "Exporter"
Lang["French"].Buttons.ExportText = "Exporter Texte"
Lang["French"].Buttons.Place = "Placer"
Lang["French"].Buttons.PickUp = "Prendre"
Lang["French"].Buttons.SaveSet = "Sauv. Set"
...
Lang["French"].Buttons.ToClipboard = "Presse-papier"
...
Lang["French"].Titles.CopyPaste = "Copier / Coller Objets"
Lang["French"].Titles.LoadSave = "Charger / Sauvegarder"
...
----------------------------------------
Lang["French"].Text = {}
Lang["French"].Text.Yaw = "Rot Y"
Lang["French"].Text.Pitch = "Rot X"
Lang["French"].Text.Roll = "Rot Z"
Lang["French"].Text.Scale = "Taille"
Lang["French"].Text.NothingSelected = "Pas de sélection"
Lang["French"].Text.NrSelectItems = "Nb. d'objets sélect. :"
Lang["French"].Text.MultiSelectItems = "%d objets sélectionnés"
...
Lang["French"].Text.LocalAxes = "Axes locaux"
Lang["French"].Text.Type = "Type"
Lang["French"].Text.Orientation = "Orientation"
Lang["French"].Text.Word = "Mot"
Lang["French"].Text.Font = "Police"
Lang["French"].Text.Size = "Taille"
...
Lang["French"].Prints = {}
--Main
Lang["French"].Prints.DimensionOnly = "Cet add-on ne s'utilise que dans les dimensions!"
Lang["French"].Prints.ProcessFinished = "Processus terminé."
Lang["French"].Prints.SetFinished = "Set d'objets \"%s\" chargé et sélectionné."
...
--Alfiebet
Lang["French"].Prints.SelectFont = "Selectionnez une police"
Lang["French"].Prints.SelectSize = "Selectionnez une taille"
Lang["French"].Prints.SelectSkin = "Selectionnez un skin"
Lang["French"].Prints.OnlyLetters = "Le mot ne doit contenir que des lettres (sans caractères spéciaux)."
Lang["French"].Prints.TypeWord = "Tapez un mot avant tout, svp!"
Lang["French"].Prints.WordMissingItems = "Impossible de créer ce mot - les objets suivants ne sont pas dans votre inventaire:"
Lang["French"].Prints.WordNeededItems = "Les objets suivants sont requis pour créer le mot \"%s\":"
Lang["French"].Prints.WordCouldNotPrint = "Impossible d'afficher les objets requis!"
--Import/Export
Lang["French"].Prints.SetNotFound = "Set d'objets \"%s\" introuvable"
Lang["French"].Prints.SelectExport = "Vous devez sélectionner un set pour l'exporter"
Lang["French"].Prints.Exported = "Set d'objets \"%s\" exporté!"
Lang["French"].Prints.SelectImport = "Vous devez sélectionner un set pour l'importer"
Lang["French"].Prints.Imported = "Set d'objets \"%s\" importé!"
Lang["French"].Prints.TextHint = "<import/export texte>\nCtrl+C: Copier\nCtrl+V: Coller\nCtrl+A: Selectionner tout\n"
--Load / Save
Lang["French"].Prints.Saved = "Set d'objets \"%s\" sauvegardé!"
Lang["French"].Prints.MinOneItem = "Vous devez sélectionner un ou plusieurs objets pour les sauvegarder"
Lang["French"].Prints.EnterName = "Vous devez entrer un nom pour sauvegarder le set"
Lang["French"].Prints.LoadNeededItems = "Les objets suivants sont requis pour charger le set \"%s\":"
Lang["French"].Prints.LoadPrintMats = "Vous devez sélectionner un set pour afficher ses composants"
