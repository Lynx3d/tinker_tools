...
LangG.Buttons.ImportText = "Text Import"
LangG.Buttons.Export = "Exportieren"
LangG.Buttons.ExportText = "Text Export"
...
LangG.Text.MultiSelectItems = "%d Gegenstände ausgewählt"
...
LangG.Text.RestoreTools = "Geöffnete Tools merken beim schließen\ndes Hauptfensters"
LangG.Text.NotIdleNotification = "Der vorherige Vorgan wurde noch nicht beendet.\nSoll der laufende Vorgang abgebrochen werden?"
...
LangG.Text.AnySkin = "<Beliebige Oberfläche>"
...
LangG.Prints.TextHint = "<Text Eingabe/Ausgabe>\nCtrl+C: Kopieren\nCtrl+V: Einfgüen\nCtrl+A: Alles auswählen\n"
--Load / Save
...
LangG.Prints.PickRefPoint =  "Bitte zuerst einen Referenzpunkt wählen."
LangG.Prints.NoRefPointWarn =  "Dieses Item Set hat keinen Referenzpunkt. Stattdessen wird der Mittelpunkt benutzt."
--Measurements
